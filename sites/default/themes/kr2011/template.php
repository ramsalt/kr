...
function kr2011_preprocess_node(&$vars){
  ...
  elseif($vars['type']=='bildegalleri'){
    ...
    foreach ($vars['field_galleri_bilde'] as $delta => $item) {
      $html .= '<li>'.$item['view'].'<p class="flex-caption">Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her Bare en test dette her </p></li>';
    }
    $html .='</ul></div>';
    $vars['content'] = $html;
  }
